...
- 14 PDFs integrais validados localmente.
- 14 extrações completas, com cobertura textual em todas as páginas.

### Pendências documentais

- 15 localizações retornaram bloqueio, página HTML, arquivo incorreto ou outra falha.
- 14 registros abertos não oferecem URL direta de PDF no OpenAlex.
