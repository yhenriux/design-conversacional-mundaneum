...
def main():
 ...
 for row in rows:
  ...
  path=ROOT/row["path"]; result={"expanded_id":row.get("expanded_id",""),"title":row["title"],"doi":row["doi"],"path":row["path"],"pages":"","encrypted":"","metadata_title":"","title_token_coverage":"0","correspondence":"false","text_sha256":"","error":""}
  try:
 ...
 fields=list(results[0]) if results else ["expanded_id","title","doi","path","pages","encrypted","metadata_title","title_token_coverage","correspondence","text_sha256","error"]
